...
void DataFilterAndOutput(void)
{
    ...
    PCapDataOutFlag = 0;
    RunVarParam.CapRes = RunVarParam.CapBak + (RunVarParam.AdjustCap * 
                            (1 - (abs((int32_t)ProductParam.CapMin - (int32_t)RunVarParam.CapBak) 
                                  / (ProductParam.CapMax - ProductParam.CapMin))));   
