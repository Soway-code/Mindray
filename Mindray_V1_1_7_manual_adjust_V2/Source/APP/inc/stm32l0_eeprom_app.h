...
#define CAP40MM1                          (CAPLOW1       + 0x04)                //40mm刻度电容1
#define CAP80MM1                          (CAP40MM1      + 0x04)                //80mm刻度电容1
#define CAPHIGH1                          (CAP80MM1      + 0x04)                //上刻度电容1
#define CAPMAX1                           (CAPHIGH1      + 0x04)                //满量程电容1
#define CAPMIN2                           (CAPMAX1       + 0x04)                //零点电容2
#define CAPLOW2                           (CAPMIN2       + 0x04)                //下刻度电容2
#define CAP40MM2                          (CAPLOW2       + 0x04)                //40mm刻度电容2
#define CAP80MM2                          (CAP40MM2      + 0x04)                //80mm刻度电容2
#define CAPHIGH2                          (CAP80MM2      + 0x04)                //上刻度电容2
#define CAPMAX2                           (CAPHIGH2      + 0x04)                //满量程电容2
#define CAPMIN3                           (CAPMAX2       + 0x04)                //零点电容3
#define CAPLOW3                           (CAPMIN3       + 0x04)                //下刻度电容3
#define CAP40MM3                          (CAPLOW3       + 0x04)                //40mm刻度电容3
#define CAP80MM3                          (CAP40MM3      + 0x04)                //80mm刻度电容3
#define CAPHIGH3                          (CAP80MM3      + 0x04)                //上刻度电容3
#define CAPMAX3                           (CAPHIGH3      + 0x04)                //满量程电容3
#define CAPMIN4                           (CAPMAX3       + 0x04)                //零点电容4
#define CAPLOW4                           (CAPMIN4       + 0x04)                //下刻度电容4
#define CAP40MM4                          (CAPLOW4       + 0x04)                //40mm刻度电容4
#define CAP80MM4                          (CAP40MM4      + 0x04)                //80mm刻度电容4
#define CAPHIGH4                          (CAP80MM4      + 0x04)                //上刻度电容4
#define CAPMAX4                           (CAPHIGH4      + 0x04)                //满量程电容4
#define CAPMIN5                           (CAPMAX4       + 0x04)                //零点电容5
#define CAPLOW5                           (CAPMIN5       + 0x04)                //下刻度电容5
#define CAP40MM5                          (CAPLOW5       + 0x04)                //40mm刻度电容5
#define CAP80MM5                          (CAP40MM5      + 0x04)                //80mm刻度电容5
#define CAPHIGH5                          (CAP80MM5      + 0x04)                //上刻度电容5
...
#define CAP40MMHEIGHT1                    (CAPLOWHEIGHT1 + 0x02)                //40mm刻度标定高度1
#define CAP80MMHEIGHT1                    (CAP40MMHEIGHT1 + 0x02)               //80mm刻度标定高度1
#define CAPHIGHHEIGHT1                    (CAP80MMHEIGHT1 + 0x02)               //上刻度标定高度1
#define CAPLOWHEIGHT2                     (CAPHIGHHEIGHT1 + 0x02)               //下刻度标定高度2
#define CAP40MMHEIGHT2                    (CAPLOWHEIGHT2 + 0x02)                //40mm刻度标定高度2
#define CAP80MMHEIGHT2                    (CAP40MMHEIGHT2 + 0x02)               //80mm刻度标定高度2
#define CAPHIGHHEIGHT2                    (CAP80MMHEIGHT2 + 0x02)               //上刻度标定高度2
#define CAPLOWHEIGHT3                     (CAPHIGHHEIGHT2 + 0x02)               //下刻度标定高度3
#define CAP40MMHEIGHT3                    (CAPLOWHEIGHT3 + 0x02)                //40mm刻度标定高度3
#define CAP80MMHEIGHT3                    (CAP40MMHEIGHT3 + 0x02)               //80mm刻度标定高度3
#define CAPHIGHHEIGHT3                    (CAP80MMHEIGHT3 + 0x02)               //上刻度标定高度3
#define CAPLOWHEIGHT4                     (CAPHIGHHEIGHT3 + 0x02)               //下刻度标定高度4
#define CAP40MMHEIGHT4                    (CAPLOWHEIGHT4 + 0x02)                //40mm刻度标定高度4
#define CAP80MMHEIGHT4                    (CAP40MMHEIGHT4 + 0x02)               //80mm刻度标定高度4
#define CAPHIGHHEIGHT4                    (CAP80MMHEIGHT4 + 0x02)               //上刻度标定高度4
#define CAPLOWHEIGHT5                     (CAPHIGHHEIGHT4 + 0x02)               //下刻度标定高度5
#define CAP40MMHEIGHT5                    (CAPLOWHEIGHT5 + 0x02)                //40mm刻度标定高度5
#define CAP80MMHEIGHT5                    (CAP40MMHEIGHT5 + 0x02)               //80mm刻度标定高度5
#define CAPHIGHHEIGHT5                    (CAP80MMHEIGHT5 + 0x02)               //上刻度标定高度5
#define CAP_EMPTY                         (CAPHIGHHEIGHT5 + 0x02)                //空电容              
#define CAP_ADJUST1                       (CAP_EMPTY     + 0x04)                //校准后的空电容差值1
#define CAP_ADJUST2                       (CAP_ADJUST1   + 0x04)                //校准后的空电容差值2
#define CAP_ADJUST3                       (CAP_ADJUST2   + 0x04)                //校准后的空电容差值3
#define CAP_ADJUST4                       (CAP_ADJUST3   + 0x04)                //校准后的空电容差值4
#define CAP_ADJUST5                       (CAP_ADJUST4   + 0x04)                //校准后的空电容差值5

#define RESET_CNT                          (CAP_ADJUST5     + 0x04)                //满值报错复位次数
